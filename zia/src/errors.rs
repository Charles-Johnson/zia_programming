...
pub enum ZiaError {
    ...
    LowestPrecendenceNotFound{tokens: Vec<String>},
    ...
    DifferentAssociativityAmongstLowestPrecendenceTokens{token: String, associativity: Associativity, other_associativity: Associativity},
